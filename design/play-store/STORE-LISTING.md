...
Console limits (title 30, short 80, full 4000, release notes 500).
...
```
Banglu: Bangla Keyboard
```
(23 chars — the old draft "Banglu - Bengali Phonetic Keyboard" was 34 and over limit)

## Short description (80 chars max)

```
Avro-style Bangla typing that is fast, private and fully offline. No ads.
```
(73 chars)
...
## Bengali (bn-BD) localized listing
...
### Short description
```
অভ্র-স্টাইলে দ্রুত বাংলা টাইপিং — সম্পূর্ণ অফলাইন, বিজ্ঞাপনমুক্ত।
```

### Full description
```
ইংরেজি অক্ষরে লিখুন, বাংলা পান — ঠিক যেভাবে আপনি অভ্রতে টাইপ করে অভ্যস্ত। বাংলুর একটাই প্রতিশ্রুতি: নির্ভরযোগ্য, ঝামেলাহীন টাইপিং।

যেভাবে লেখেন, সেভাবেই লিখুন
• অভ্র-সামঞ্জস্যপূর্ণ ফোনেটিক টাইপিং: ami → আমি, kemon acho → কেমন আছো
...
কোনো শব্দ ভুল এলে জানান — প্রতিটি আপডেটে ব্যবহারকারীদের রিপোর্ট থেকেই বানানের কাভারেজ বাড়ে।
